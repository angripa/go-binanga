...
import (
	context "context"
	database "binanga/internal/article/database"

	mock "github.com/stretchr/testify/mock"

	model "binanga/internal/article/model"
)
...
type mockConstructorTestingTNewArticleDB interface {
	mock.TestingT
	Cleanup(func())
}

// NewArticleDB creates a new instance of ArticleDB. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewArticleDB(t mockConstructorTestingTNewArticleDB) *ArticleDB {
	mock := &ArticleDB{}
	mock.Mock.Test(t)
